...
Pod::Spec.new do |s|
  ...
  s.author             = { "zhangxiwei" => "zhangxiwei@sogou-inc.com" }
  # Or just: s.author    = "zhangxiwei"
  # s.authors            = { "zhangxiwei" => "zhangxiwei@sogou-inc.com" }
  # s.social_media_url   = "http://twitter.com/zhangxiwei"
  ...
  s.source       = { :git => "https://github.com/httpmanager.git", :tag => "#{s.version}" }
